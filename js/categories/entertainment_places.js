     ...
     'torgovie_ryadi': {
        ...
        usefulInfo: {
            ...
            content: [
                ...
                'Часы работы: ежедневно, 10:00-17:00. (в порядке живой очереди) <br> *На Я.Картах написано, что Центр закрыт – это неверно.',
...
'dymov_keramika': {
        ...
        usefulInfo: {
            ...
            content: [
                ...
                '•Экскурсия по производству – 1000₽ (взрослый), 600₽ (ребёнок)<br>',
